 ...
 class clase_mysql{
  ...
  function mapa(){
    ...
    while (@$row = mysql_fetch_array($this->Consulta_ID)) {
        ...
        echo "<div class='row'>";
         echo "<div class='col-md-6'>";
         echo "<a href='actua.php?tipo=aceptado&id=$id'<button type='submit' class='btn btn-default' style='background: #000000'; color:'#FFFFFF'>Confirmar</button></a>";
         echo "</div>";


          echo "<div class='col-md-6'>";
          echo "<a href='actua.php?tipo=cancelado&id=$id'><button type='submit' class='btn btn-default' style='background: #000000'; color:'#FFFFFF'>Rechazar</button></a>";
          echo "<br><br>";
          echo "<br><br>";
          echo "<br><br>";
          echo "<br><br>";
